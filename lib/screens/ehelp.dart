...
import 'package:charify/models/food_model.dart'; // Import your food model
...
class _EHelpState extends State<EHelp> {
  ...
  PageController? _pageController; // Nullable PageController
  int? prevPage; // Nullable prevPage
          ...
          Container(
            ...
            child: GoogleMap(
              initialCameraPosition: CameraPosition(
                  target: LatLng(0.33322431047207657, 32.56859208637059),
                  zoom: 12.0),
